...
class Gangguan_daop5 extends CI_Controller {
	...
	function __construct(){
		...
		$this->load->model('Gangguan_model_daop5');
	}
	...
	public function index()
	{
		...
		$data['laporan'] = $this->Gangguan_model_daop5->getAllData($config['per_page'],  $data['start'],  $data['keyword']);
		$data['daerah'] = $this->Gangguan_model_daop5->getDataDaerahOperasi();
        $data['jenis'] = $this->Gangguan_model_daop5->getDataJenisGangguan();
		$data['jumlah_sintelis'] = $this->Gangguan_model_daop5->getJumlahDataSintelis();
		$data['jumlah_jj'] = $this->Gangguan_model_daop5->getJumlahDataJJ();
		$data['jumlah_eksternal'] = $this->Gangguan_model_daop5->getJumlahDataEksternal();
		$data['jumlah_kamtib'] = $this->Gangguan_model_daop5->getJumlahDataKamtib();

        $data['user'] = $this->db->get_where('user', ['nipp' => $this->session->userdata('nipp')])->row_array();
		$this->load->view('templates/header', $data);
		$this->load->view('templates/sidebar');
		$this->load->view('daop_5/monitoring', $data);
    ...
    public function add_data()
    {
		...
		$this->load->view('templates/header', $data);
		$this->load->view('templates/sidebar');
		$this->load->view('daop_5/input_gangguan',$data);
		$this->load->view('templates/footer');
        }else{
            ...
            $this->Gangguan_model_daop5->save($data);
	...
	{
		$this->Gangguan_model_daop5->delete($id_laporan);
    ...
    public function edit_data($id_laporan)
    {
        ...
        $this->Gangguan_model_daop5->update($id_laporan, $data);
    ...
    public function export_data_excel()
    {
        ...
        $sheet->setCellValue('A1', 'Data Laporan Gangguan - Daop 5');
        ...
        $data = $this->Gangguan_model_daop5->getData();
        $x= 4;
        foreach ($data as $row) {
            $no=1;
        ...
        $filename = 'laporan_gangguan_daop5.xlsx';
