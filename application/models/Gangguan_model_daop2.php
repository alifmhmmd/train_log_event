<?php
class Gangguan_model_daop2 extends CI_Model{
    ...
    {
        $query = $this->db->select('id_jenis')->from('laporan_gangguan')->where('id_jenis', '1')->where('id_daop', '2')->get();
        if($query->num_rows()>0)
        {
    ...
    {
        $query = $this->db->select('id_jenis')->from('laporan_gangguan')->where('id_daop', '2')->where('id_jenis', '2')->get();
        if($query->num_rows()>0)
        {
            return $query->num_rows();
        }
    ...
    {
        $query = $this->db->select('id_jenis')->from('laporan_gangguan')->where('id_daop', '2')->where('id_jenis', '3')->get();
        if($query->num_rows()>0)
        {
            return $query->num_rows();
        }
    ...
    {
        $query = $this->db->select('id_jenis')->from('laporan_gangguan')->where('id_daop', '2')->where('id_jenis', '4')->get();
        if($query->num_rows()>0)
        {
            return $query->num_rows();
        }
