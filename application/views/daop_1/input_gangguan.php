                ...
                <div class="col-xl-12 col-xxl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">DAOP 1 | Input Gangguan</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="" method="post" class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="id_daop" name="id_daop" placeholder="DAOP 1" readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6 <?= form_error('uraian') ? 'has-error' : null ?>">
                                    ...
                                    <textarea class="form-control" rows="4" id="uraian" name="uraian"><?= set_value('uraian'); ?></textarea>
                                    <?= form_error('uraian'); ?>
                                </div>
