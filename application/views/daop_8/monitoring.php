            ...
            <div class="container-fluid">
                <div class="col-lg-12 page-titles mr-1">
                    <div class="col-sm-12 p-md-0 justify-content-sm-end mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">DAOP 8</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">DAOP 8 | Data Laporan Gangguan</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div class="form-inline justify-content-between mb-2">
                                        ...
                                        <div class="col-lg-6 justify-content-end d-flex">
                                            <form action="<?php base_url("daop_8/gangguan"); ?>" method="post" class="form-inline ">
        ...
        ***********************************-->
        ...
        <div class="modal fade" id="editModal<?= $row['id_laporan']; ?>">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">DAOP 8 | Edit Data Gangguan</h5>
                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                        </button>
                    </div>
